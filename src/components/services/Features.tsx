...
const Features = () => {
  return (
    <section className="relative overflow-hidden pt-14 pb-24 md:pt-16 md:pb-36 lg:pt-[200px] lg:pb-[100px] xl:pt-[100px] xl:pb-[200px]">
      <div className="main-container">
        <div className="flex flex-wrap items-center gap-y-8 lg:flex-nowrap lg:gap-4 xl:gap-8">
          <div className="w-full lg:w-1/2">
            <div className="text-center lg:text-left">
              <RevealAnimation delay={0.1}>
                <span className="badge badge-yellow-v2 mb-5">Feature</span>
              </RevealAnimation>
              ...
              <RevealAnimation delay={0.6}>
                <div>
                  <LinkButton href="/features" className="btn btn-xl dark:btn-transparent hover:btn-primary btn-white">
                    Get started
                  </LinkButton>
                </div>
              </RevealAnimation>
