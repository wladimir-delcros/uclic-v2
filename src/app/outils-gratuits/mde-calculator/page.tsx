...
export const metadata: Metadata = {
  title: 'Calculateur MDE — Taille d\'échantillon A/B Test',
  description:
    "Calculez la taille d'échantillon nécessaire pour détecter un écart relatif donné (MDE) entre contrôle et variante. Outil gratuit Uclic.",
  ...
  openGraph: {
    ...
    title: 'Calculateur MDE — Taille d\'échantillon A/B Test',
    description:
      "MDE, sample size et durée de test pour votre prochain A/B. Gratuit, par Uclic.",
    siteName: 'Uclic',
    locale: 'fr_FR',
